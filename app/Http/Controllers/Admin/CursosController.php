...
class CursosController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()) {
            ...
            return redirect()->route('admin.cursos.index')->with('guardar', 'ok');
        } else {
            Auth::logout();
            return redirect()->back();
        }
    ...
    public function update(Request $request, $id)
    {
        if (Auth::user()) {
            ...
            return redirect()->route('admin.cursos.index')->with('actualizar', 'ok');
        } else {
            Auth::logout();
            return redirect()->back();
        }
    ...
    public function destroy($id)
    {
        if (Auth::user()) {
            ...
            return redirect()->route('admin.cursos.index')->with('eliminar', 'ok');
        } else {
            Auth::logout();
            return redirect()->back();
        }
