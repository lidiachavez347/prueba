    ...
    <table id="productos" class="table table striped shadow-lg mt-4table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('admin.permisos.destroy', $permiso->id) }}" class="formulario-eliminar"
                        method="POST">

                        <a href="{{ route('admin.permisos.show', $permiso->id) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Ver">
                            <i class="fa fa-eye" aria-hidden="true"></i>
                        </a>

                        <a href="{{ route('admin.permisos.edit', $permiso->id) }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="Editar">
