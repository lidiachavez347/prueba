<div class="row">
    ...
    <div class="form-group">
                ...
                {!! Form::select('roles', $roles, $profesor->id_rol, ['class' => 'form-control']) !!}
...
<div class="row">
    ...
    <div class="form-group">
                ...
                {!! Form::tel('telefono', old('telefono', $profesor->telefono), ['class' => 'form-control', 'placeholder' => 'Número de teléfono']) !!}
                @error('telefono')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        @if ($profesor->imagen > 0)
        <center>
            <div class="grid grid-cols-1 mt-5 mx-7">
                <img id="imagenseleccionada" src="{{ URL::asset("images/{$profesor->imagen}") }}"
...
$(document).ready(function() {
    ...
    function evaluarFuerza(password) {
        ...
        if (fuerza <= 2) return {msg: 'Contraseña muy débil', color: 'red'};
        if (fuerza === 3 || fuerza === 4) return {msg: 'Contraseña aceptable', color: 'orange'};
