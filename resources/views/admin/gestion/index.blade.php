...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Lista de Gestiones</h1>
        </div>
        <div class="col-sm-6">
...
<div class="modal-footer">
    <a href="{{ route('admin.gestion.create') }}" class="btn btn-dark" data-toggle="tooltip" data-placement="left" title="Adicionar">
        ...
        <tbody>
            ...
            <tr id="usuario-{{ $gestion->id }}">
                ...
                <td>
                    ...
                    <!--- BOTON EDITAR--->
                    <a href="javascript:void(0);" onclick="abrirModalEditar('{{$gestion->id}}')" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="Editar">
                        <i class="fas fa-edit"></i>
                    </a>
                    <!--- BOTON ELIMINAR--->
                    <button onclick="eliminarUsuario('{{ $gestion->id }}')" class="btn btn-danger btn-sm" aria-label="eliminar" data-toggle="tooltip" data-placement="top" title="Eliminar">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Detalles del Gestion</h5>
                    ...
                    <div class="modal fade" id="editarUsuarioModal" tabindex="-1" aria-labelledby="editarUsuarioLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editarUsuarioLabel">Editar Gestion</h5>
...
<script>
    $(document).on('click', '.view-user', function(e) {
        ...
        $.ajax({
            url: '{{ route("admin.gestion.show", ":id") }}'.replace(':id', userId),
            method: 'GET',
    ...
    function eliminarUsuario(userId) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("admin.gestion.destroy", ":id") }}'.replace(':id', userId),
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
...
<script>
    function abrirModalEditar(userId) {
        ...
        $.ajax({
            url: '{{ route("admin.gestion.edit", ":id") }}'.replace(':id', userId),
            type: 'GET',
            success: function(response) {
