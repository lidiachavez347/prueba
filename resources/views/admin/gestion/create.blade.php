    ...
    <div class="col-12 col-md-8 col-lg-6">
        <div class="card">
            ...
            <div class="card-header">
                <div class="left">Gestion</div>
                <div class="right"><b>Nuevo</b></div>
            </div>
            {!! Form::open(['route' => 'admin.gestion.store', 'enctype' => 'multipart/form-data']) !!}
            <div class="card-body">
            ...
            <div class="card-footer ">
                <center>
                    <a class='btn btn-danger  btn-sm href' href="{{ route('admin.gestion.index') }}" data-toggle="tooltip" data-placement="top" title="Cancelar">
