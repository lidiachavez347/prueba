...
<div class="modal-footer">
    ...
    <a href="{{ route('admin.roles.create') }}" class="btn btn-light" data-toggle="tooltip" data-placement="left" title="Exportar">
    ...
    <table id="productos" class="table table striped shadow-lg mt-4table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('admin.roles.destroy', $role->id) }}" class="formulario-eliminar"
                        method="POST">
                        <a href="{{ route('admin.roles.show', $role->id) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Ver">
