...
<div class="modal-footer">
    <a href="{{ route('director.cursos.create') }}" class="btn btn-dark" data-toggle="tooltip" data-placement="left" title="Adicionar">
    ...
    <table id="productos" class="table table striped shadow-lg mt-4table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                <form action="{{ route('director.cursos.destroy', $curso->id) }}" class="formulario-eliminar"
                        method="POST">
                        <a href="{{ route('director.cursos.edit', $curso->id) }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="left" title="Editar">
