...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Notas Dimension SER 15</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"> Dimension Ser</li>
            </ol>
        </div>
    </div>
...
<form action="{{ route('profesor.ser.index') }}" method="GET" class="mb-4" id="prueba">
    <div class="row">
        <div class="col-md-3">
...
<form method="POST" action="{{ route('profesor.ser.store') }}">
    @csrf
...
function eliminarCriterio(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch(`/profesor/ser/criterio/${id}/eliminar`, {
                method: 'DELETE',
                headers: {
...
function editarCriterioCompleto(id) {
    ...
    $.get(`/profesor/ser/criterio/${id}/data`, function(response) {
...
function guardarCriterio() {
    ...
    // Enviar
    $.post(`/profesor/ser/criterio/${id}/actualizar`, datos, function() {
        location.reload();
    });
}
