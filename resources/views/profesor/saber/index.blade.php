...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Notas Dimension saber 35</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"> Dimension Saber</li>
            </ol>
        </div>
    </div>
...
<form action="{{ route('profesor.saber.index') }}" method="GET" class="mb-4" id="prueba">
    <div class="row">
        <div class="col-md-3">
...
<form method="POST" action="{{ route('profesor.saber.store') }}">
    @csrf
        <div class="header">
...
function eliminarCriterio(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch(`/profesor/saber/criterio/${id}/eliminar`, {
                method: 'DELETE',
                headers: {
...
function editarCriterioCompleto(id) {
    ...
    $.get(`/profesor/saber/criterio/${id}/data`, function(response) {
...
function guardarCriterio() {
    ...
    // Enviar
    $.post(`/profesor/saber/criterio/${id}/actualizar`, datos, function() {
        location.reload();
    });
}
