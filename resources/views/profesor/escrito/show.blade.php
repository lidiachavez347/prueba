...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Evaluacion: {{ $actividad->nombre }}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"> Calificar evaluaciones</li>
            </ol>
        </div>
    </div>
...
<div class="card body py-2 px-1">
    ...
    @if($actualizar == 0)
    <form action="{{ route('profesor.escrito.store', $actividad->id) }}" method="POST">
        @csrf
        ...
        <table id="productos" class="table table striped shadow-lg mt-4table table-striped">
            ...
            <tbody>
                ...
                <td>{{ $loop->iteration }}</td>
                    ...
                    <td><input type="text" name="estudiantes[{{ $estudiante->estudiante_id }}][observacion]" class="form-control"></td>
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    @else
    <form action="{{ route('profesor.escrito.update', $actividad->id) }}" method="POST">
        @csrf
        @method('PUT')
