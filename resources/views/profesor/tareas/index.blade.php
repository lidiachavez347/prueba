...
<div class="modal-footer">
    ...
    <a href="{{ route('profesor.tareas.create') }}" class="btn btn-dark" data-toggle="tooltip" data-placement="left" title="Adicionar">
        <i class="fa fa-plus-circle" aria-hidden="true"></i> Tarea</a>
</div>
        ...
        <tbody>
            ...
            <tr id="permiso-{{ $tarea->id }}">
                ...
                <td>
                    ...
                    @if($tarea->tipo == 'AULA')
                    <a href="{{ route('profesor.aula.show',$tarea->id) }}"
                        class="btn btn-dark btn-sm"
                        title="Tarea en aula">
                        <i class="fa fa-chalkboard-teacher" aria-hidden="true"></i> {{-- Icono para aula --}}
                    </a>
                    @elseif($tarea->tipo == 'CASA')
                    <a href="{{ route('profesor.casa.show',$tarea->id) }}"
                        class="btn btn-dark btn-sm"
                        title="Tarea en casa">
