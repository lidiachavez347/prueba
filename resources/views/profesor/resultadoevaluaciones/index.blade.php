...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Notas de Estudiantes SABER</h1>
        </div>
        <div class="col-sm-6">
...
<form action="{{ route('profesor.resultadoevaluaciones.index') }}" method="GET" class="mb-4">
    <div class="row">
        <div class="col-md-3">
    ...
    <table id="productos" class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    {{ $nota !== null ? $nota : '--' }} <!-- Mostrar la nota o 0 -->
                </td>
                @endforeach
